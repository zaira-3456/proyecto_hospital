...
class _AgregarPersonalScreenState extends State<AgregarPersonalScreen> {
  ...
  final List<String> areas = ['Urgencias', 'Farmacia', 'Consulta Externa', 'Administración', 'Finanzas'];
                    ...
                    MaterialPageRoute(
                      builder: (_) => PantallaAsignarUsuario(
                        personalData: {
                          ...
                          'fechaNacimiento': nacimientoCtrl.text, // Should be DateTime in real app
                          'curp': curpCtrl.text,
                          'rfc': rfcCtrl.text,
