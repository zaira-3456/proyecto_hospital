...
class _DoctorRecordsScreenState extends State<DoctorRecordsScreen> {
  ...
  Widget build(BuildContext context) {
    final patients = _recordPatients;
  ...
  Widget _buildVitals() {
    ...
    return Column(
      children: [
        Row(
          children: [
            box('Presión Arterial', _bp, 'mmHg', (v) => _bp = v),
            box('Frecuencia Cardíaca', _hr, 'bpm', (v) => _hr = v),
          ],
        ),
        Row(
          children: [
            box('Peso', _weight, '', (v) => _weight = v),
            box('Altura', _height, '', (v) => _height = v),
          ],
        ),
      ],
    );
...
const _recordPatients = <RecordPatient>[
  RecordPatient(
    ...
    medicamentos: [
      RecordMed(
        nombre: 'Losartán',
        detalle: '50 mg - 1 vez al día',
      ),
      RecordMed(
        nombre: 'Aspirina',
        detalle: '100 mg - 1 vez al día',
      ),
    ],
    visitas: [
      RecordVisit(
